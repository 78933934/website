                        ...
                        <div class="box-body">
                            ...
                            <div class="fields-group">
                                ...
                                <div class="form-group  ">
                                    ...
                                    <label for="module_image_file" class="col-sm-2 asterisk control-label">封面主图</label>

                                    <div class="col-sm-8">

                                        <input type="file" class="form-control module_image_file" name="module_image_file" required="1" />
